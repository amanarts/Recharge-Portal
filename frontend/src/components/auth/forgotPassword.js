...
import ForgotPassword from "./../../img/forgot.svg";
    ...
    <div>
      <div className="container1">
        <div className="box" id="logoBlock1">
          <img src={ForgotPassword} className="Imagef"></img>
        </div>
        <div id="loginBlock" className="box">
          <div className="heading1 mb-3">Forgot Password</div>
          <div id="loginbox">
          ...
          <div className="center" id="buttonArea">
            ...
            <Link to='/login' className="btn-link">
              <HomeButton buttonStyle='btn--outline'>Receive OTP on Email</HomeButton>
            </Link>
